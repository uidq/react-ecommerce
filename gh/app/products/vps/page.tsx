...
import { Check, CreditCard, Building2, User, Globe, Globe2, Sparkles, Shield, Server } from "lucide-react";
...
const VPSTier = ({ name, price, description, features, buttonText, isPopular }: VPSTierProps) => {
  return (
...
const VPSDialog = ({ buttonText, tier, price }: VPSDialogProps) => {
  return (
    <Dialog>
