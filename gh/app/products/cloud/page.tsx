...
const CloudTier = ({ name, price, description, features, buttonText, isPopular }: CloudTierProps) => {
  return (
    <div className="relative group">
      ...
      <Card className="flex flex-col h-full bg-[#111111] border-zinc-800 hover:border-zinc-600 transition-all duration-300 hover:transform hover:-translate-y-1 hover:shadow-xl">
        ...
        <CardFooter className="px-8 pb-8">
          <CloudDialog buttonText={buttonText} tier={name} price={price} />
        </CardFooter>
      </Card>
    </div>
  );
...
const CloudDialog = ({ buttonText, tier, price }: CloudDialogProps) => {
  return (
    <Dialog>
