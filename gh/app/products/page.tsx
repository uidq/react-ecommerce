...
const PricingTier = ({ name, price, description, features, buttonText }: any) => {
  return (
    <Card className="flex flex-col h-full bg-[#111111] border-zinc-800">
      ...
      <CardFooter className="px-8 pb-8">
        <PricingDialog buttonText={buttonText} tier={name} price={price} />
      </CardFooter>
    </Card>
  );
};

const PricingDialog = ({ buttonText, tier, price }: any) => {
  return (
    <Dialog>
